...
const getDailyLesson = async (req, res) => {
  try {
    ...
    // CONSULTA AO BANCO COM FUSO HORÁRIO EXPLÍCITO E DEFINITIVO
    ...
    console.log(`Usuário '${req.user.usuario}' acessou a lição. Flag 'userHasSubmitted' está: ${userHasSubmitted}`);
